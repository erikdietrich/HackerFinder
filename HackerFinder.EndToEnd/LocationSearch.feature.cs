...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Wheeling Search")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "LocationSearch")]
        public virtual void WheelingSearch()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Wheeling Search", ((string[])(null)));
#line 4
...
#line 7
 testRunner.And("I should have a user with last name Dietrich", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 8
 testRunner.And("I should have a user with email address erik@daedtech.com", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 9
 testRunner.And("I should have a user with profile url \"https://github.com/erikdietrich\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
